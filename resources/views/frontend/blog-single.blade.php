        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="news-img-box">
              <img src="{{url('frontend/assets/img/slide-3.jpg')}}" alt="" class="img-fluid">
            </div>
          </div>
              ...
              <ul class="list-comments">
                <li>
                  <div class="comment-avatar">
                    <img src="{{url('frontend/assets/img/author-2.jpg')}}" alt="">
                  </div>
                ...
                <li class="comment-children">
                  <div class="comment-avatar">
                    <img src="{{url('frontend/assets/img/author-1.jpg')}}" alt="">
                  </div>
                  <div class="comment-details">
